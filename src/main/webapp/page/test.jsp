...
<head>
    ...
    <script type="text/javascript">
        ...
        function supplierModify(){
            ...
            $("#fm").form("load",row);
            url="${pageContext.request.contextPath}/supplier/save.do?supplierId="+row.supplierId;
        }
...
<table id="dg" title="供应商管理" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="supplierId" width="30" align="center" hidden="true">编号</th>
        <th field="supplierNo" width="100" align="center">供应商编号</th>
        <th field="supplierName" width="100" align="center">供应商名称</th>
        ...
        <th field="comment" width="200" align="center">备注</th>
    </tr>
    </thead>
</table>
...
<div id="tb">
    ...
    <div>
        ...
        &nbsp;&nbsp;供应商名称：&nbsp;<input type="text" id="s_supplierName" size="20" onkeydown="if(event.keyCode==13) searchSupplier()"/>
...
<div id="dlg" class="easyui-dialog" style="width: 600px;height: 250px;padding: 10px 20px" closed="true" buttons="#dlg-buttons">
    <form id="fm" method="post">
        <table style="margin: 5px" cellspacing="8px">
            <tr>
                <td>供应商名字：</td>
                <td><input type="text" id="supplierName" name="supplierName" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
            ...
            <tr>
                ...
                <td>电   话：</td>
                <td><input type="text" id="phone" name="phone" class="easyui-validatebox" required="true" data-options="validType:'telephone'"/>&nbsp;<font color="red">*</font></td>
            </tr>
            <tr>
                <td>邮   箱：</td>
                ...
                <td>备   注：</td>
                <td><input type="text" id="comment" name="comment" class="easyui-validatebox"/></td>
            </tr>
        </table>
    </form>
