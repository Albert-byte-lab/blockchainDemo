...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	<script src="../resources/login/js/respond.min.js"></script>
	<![endif]-->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<ul class="menu">
						<li class="active"><Strong>飞行零部件全生命周期管理系统</Strong></li>
					</ul>
				</div>
			</div>
			<div class="row">
	...
	<!-- login  -->
	<script type="text/javascript" src="../resources/login.js" charset="utf-8"></script>
	</body>
</html>
